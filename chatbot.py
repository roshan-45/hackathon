...
def analyze_logs(logs: List[Document], question: str) -> str:
    ...
    1. Summary of relevant log entries
    2. Specific issues identified
    3. Technical solutions or next steps
...
def main():
    try:
        # Read the question from chatbot_input.json
        with open("chatbot_input.json", "r") as f:
    ...
    response = {"response": result["analysis"] if result["analysis"] else "Unable to generate an answer."}
    with open("chatbot_output.json", "w") as f:
